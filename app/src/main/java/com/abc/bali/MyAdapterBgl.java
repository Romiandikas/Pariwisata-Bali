...
public class MyAdapterBgl extends RecyclerView.Adapter<PlaceViewHolderK> {
    ...
    MyAdapterBgl(Context context, int[] images, String[] placeNames, String[] placeGuide) {
    ...
    public PlaceViewHolderK onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recyclerview_bangli_row, parent, false);
...
class PlaceViewHolderBgl extends RecyclerView.ViewHolder {
    ...
    PlaceViewHolderBgl(View itemView) {
        super(itemView);
