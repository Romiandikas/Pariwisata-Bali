...
public class MyAdapterR extends RecyclerView.Adapter<PlaceViewHolderK> {
    ...
    MyAdapterR(Context context, int[] images, String[] placeNames, String[] placeGuide) {
    ...
    public PlaceViewHolderK onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recyclerview_belanja_row, parent, false);
...
class PlaceViewHolderR extends RecyclerView.ViewHolder {
    ...
    PlaceViewHolderR(View itemView) {
        super(itemView);
