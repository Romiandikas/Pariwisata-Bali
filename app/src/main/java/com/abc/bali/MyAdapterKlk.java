...
public class MyAdapterKlk extends RecyclerView.Adapter<PlaceViewHolderK> {
    ...
    MyAdapterKlk(Context context, int[] images, String[] placeNames, String[] placeGuide) {
    ...
    public PlaceViewHolderK onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recyclerview_klungkung_row, parent, false);
...
class PlaceViewHolderKlk extends RecyclerView.ViewHolder {
    ...
    PlaceViewHolderKlk(View itemView) {
        super(itemView);
