...
public class MyAdapterKarangasem extends RecyclerView.Adapter<PlaceViewHolderK> {
    ...
    MyAdapterKarangasem(Context context, int[] images, String[] placeNames, String[] placeGuide) {
    ...
    public PlaceViewHolderK onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recylerview_karangasem_row, parent, false);
...
class PlaceViewHolderKarangasem extends RecyclerView.ViewHolder {
    ...
    PlaceViewHolderKarangasem(View itemView) {
        super(itemView);
