...
public class MyAdapterB extends RecyclerView.Adapter<PlaceViewHolderK> {
    ...
    MyAdapterB(Context context, int[] images, String[] placeNames, String[] placeGuide) {
...
class PlaceViewHolderB extends RecyclerView.ViewHolder {
    ...
    PlaceViewHolderB(View itemView) {
        super(itemView);
