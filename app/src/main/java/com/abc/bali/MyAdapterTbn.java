...
public class MyAdapterTbn extends RecyclerView.Adapter<PlaceViewHolderK> {
    ...
    MyAdapterTbn(Context context, int[] images, String[] placeNames, String[] placeGuide) {
    ...
    public PlaceViewHolderK onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recyclerview_tabanan_row, parent, false);
...
class PlaceViewHolderTbn extends RecyclerView.ViewHolder {
    ...
    PlaceViewHolderTbn(View itemView) {
        super(itemView);
