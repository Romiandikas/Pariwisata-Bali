...
public class MyAdapterGyr extends RecyclerView.Adapter<PlaceViewHolderK> {
    ...
    MyAdapterGyr(Context context, int[] images, String[] placeNames, String[] placeGuide) {
...
class PlaceViewHolderGyr extends RecyclerView.ViewHolder {
    ...
    PlaceViewHolderGyr(View itemView) {
        super(itemView);
