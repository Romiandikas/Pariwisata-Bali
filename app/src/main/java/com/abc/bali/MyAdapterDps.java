...
public class MyAdapterDps extends RecyclerView.Adapter<PlaceViewHolderK> {
    ...
    MyAdapterDps(Context context, int[] images, String[] placeNames, String[] placeGuide) {
    ...
    public PlaceViewHolderK onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recylerview_denpasar_row, parent, false);
...
class PlaceViewHolderDps extends RecyclerView.ViewHolder {
    ...
    PlaceViewHolderDps(View itemView) {
        super(itemView);
