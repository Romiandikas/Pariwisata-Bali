...
public class MyAdapterJbr extends RecyclerView.Adapter<PlaceViewHolderK> {
    ...
    MyAdapterJbr(Context context, int[] images, String[] placeNames, String[] placeGuide) {
    ...
    public PlaceViewHolderK onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recylerview_jembrana_row, parent, false);
...
class PlaceViewHolderJbr extends RecyclerView.ViewHolder {
    ...
    PlaceViewHolderJbr(View itemView) {
        super(itemView);
