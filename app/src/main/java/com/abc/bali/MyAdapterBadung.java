...
public class MyAdapterBadung extends RecyclerView.Adapter<PlaceViewHolderK> {
    ...
    MyAdapterBadung(Context context, int[] images, String[] placeNames, String[] placeGuide) {
    ...
    public PlaceViewHolderK onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recyclerview_badung_row, parent, false);
...
class PlaceViewHolderBadung extends RecyclerView.ViewHolder {
    ...
    PlaceViewHolderBadung(View itemView) {
        super(itemView);
