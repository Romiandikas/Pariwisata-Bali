...
public class MyAdapterBul extends RecyclerView.Adapter<PlaceViewHolderK> {
    ...
    MyAdapterBul(Context context, int[] images, String[] placeNames, String[] placeGuide) {
    ...
    public PlaceViewHolderK onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recylerview_buleleng_row, parent, false);
...
class PlaceViewHolderBul extends RecyclerView.ViewHolder {
    ...
    PlaceViewHolderBul(View itemView) {
        super(itemView);
